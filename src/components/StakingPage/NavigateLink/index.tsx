...
const NEW_STAKING_MEDIUM_LINK =
  'https://hakkafinance.medium.com/hakka-finance-token-staking-model-upgrade-1c34d1bb82f6';
export default function NavigateLink() {
  ...
  return (
    <div sx={styles.wrapper} onClick={onClick}>
      ...
      <div className='navigate-link'>Read more about updates and migration</div>
