  ...
  return (
    <div>
      ...
      <div style={{ marginTop: isMobile ? '28px' : '40px' }}>
        <InfoItem
          icon={images.iconHakkaCoinSmall}
          value={totalStakedHakka}
          title={
            <p style={styles.title}>
              Total <span style={{ fontWeight: 'bold' }}>HAKKA</span> staked
            </p>
          }
        />
        <InfoItem
          icon={images.iconShakkaCoin}
          value={totalSHakkaObtained}
          title={
            <p style={styles.title}>
              Total <span style={{ fontWeight: 'bold' }}>sHAKKA</span> obtained
            </p>
          }
        />
        <InfoItem
          icon={images.iconFarmsSmall}
          value={farmingSHakka}
          title={
            <p style={styles.title}>
              Farming <span style={{ fontWeight: 'bold' }}>sHAKKA</span>
            </p>
          }
        />
        <InfoItem
          ...
          title={
            <p style={styles.title}>
              Wallet <span style={{ fontWeight: 'bold' }}>sHAKKA</span>
            </p>
          }
        />
      </div>
