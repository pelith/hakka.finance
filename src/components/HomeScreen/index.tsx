    ...
    <Box>
      <Box sx={styles.homescreenContainer}>
        <Box sx={{ display: 'inline-block' }}>
          <Flex
            ...
            onClick={() => {
              window.open(
                'https://pelith.notion.site/pelith/Hakka-Finance-Pelith-is-hiring-27bfdd1991bc46019f69f5c7926b69fb',
                '_blank',
                'noopener, noreferrer',
              );
            }}
          >
            ...
            <span>
              Hakka Finance is&nbsp;
              <span sx={{ textDecoration: 'underline' }}>hiring</span>. Come
              join us!
            </span>
          </Flex>
        </Box>
        ...
        <Box sx={styles.homeDescription}>
          <p>
            ...
            financial instruments, forming an all-inclusive ecosystem of tools
            that allow users to pursue financial sovereignty.
          </p>
        </Box>
      ...
      <Box sx={styles.homescreenContainer}>
        ...
        <Box sx={styles.partners}>
          ...
          <Flex sx={styles.img_partners_responsive} flexWrap='wrap'>
            {renderPartnersImg()}
          </Flex>
        </Box>
        ...
        <Box>
          ...
          <p sx={styles.subscribeSubtitle}>
            Don't Miss Out On The Future of DeFi & Get $HAKKA Rewards Before
            Everyone
          </p>
          {/* Begin Mailchimp Signup Form */}
          <form
            action='https://finance.us2.list-manage.com/subscribe/post?u=95f3e0652dfcf25540fb560b5&amp;id=944615c8c1'
            method='post'
          ...
          >
            <div sx={styles.subscribeInputArea}>
              <input
                ...
                onChange={(event) =>
                  setSubscribeEmailAddress(event.target.value)
                }
                type='email'
                name='EMAIL'
              ...
              >
                <input
                  type='text'
                  name='b_95f3e0652dfcf25540fb560b5_944615c8c1'
                  tabIndex={-1}
                  value=''
                />
              </div>
