...
export interface ApproveTokenCheckWrapperInterface
...
const withApproveTokenCheckWrapper =
  <T extends object>(WrappedComponent: React.ComponentType<T>) =>
  (props: T & ApproveTokenCheckWrapperInterface) => {
    const {
    ...
    const childrenElement =
      !isApproved && !isDisabledWhenNotPrepared ? 'Unlock Token' : children;
