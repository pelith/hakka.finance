...
export interface ConnectWalletCheckWrapperInterface
...
const withConnectWalletCheckWrapper =
  <T extends object>(WrappedComponent: React.ComponentType<T>) =>
  (props: T & ConnectWalletCheckWrapperInterface) => {
    const {
    ...
    const childrenElement =
      !isConnected && !isDisabledWhenNotPrepared ? 'Connect Wallet' : children;
