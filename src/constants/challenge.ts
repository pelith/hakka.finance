...
export const PriorityInfo: {
  [key in PriorityOptions]: { content: string; color: string };
} = {
...
export const OAT_INFO: {
  [key: string]: {
    missionIndex?: number;
    img: `mission${MissionOptions}`;
    reward?: string;
  ...
  [MISSION_CAMPAIGN_ID[MissionOptions.MISSION1_1]]: {
    ...
    describeContent: `gm Hakka Farmer and welcome to your native planet! 🪐  \n
  ...
  [MISSION_CAMPAIGN_ID[MissionOptions.MISSION1_2]]: {
    ...
    missionLink:
      'https://hakka.finance/staking?utm_source=galaxy&utm_medium=nft&utm_campaign=play2earn_1_2',
  ...
  [MISSION_CAMPAIGN_ID[MissionOptions.MISSION1_4]]: {
    ...
    missionLink:
      'https://igain.finance/irs/fixed-apy?utm_source=galaxy&utm_medium=nft&utm_campaign=play2earn_1_4',
  ...
  [MISSION_CAMPAIGN_ID[MissionOptions.MISSION2_2]]: {
    ...
    missionLink:
      'https://hakka.finance/farms/?utm_source=galaxy&utm_medium=nft&utm_campaign=play2earn_2_2',
...
export const LevelInfo: Record<`${number}`, LevelInfoType> = {
  '1': {
    title: 'Newbie DeFi Farmer',
    introduction:
      'Your DeFi journey across the Galaxy starts here, young farmer! Before taking off, prepare yourself by learning the basics of DAOs and DeFi!',
    missionList: [
      MISSION_CAMPAIGN_ID[MissionOptions.MISSION1_1],
      MISSION_CAMPAIGN_ID[MissionOptions.MISSION1_2],
      MISSION_CAMPAIGN_ID[MissionOptions.MISSION1_3],
  ...
  '2': {
    ...
    introduction:
      'Congrats and welcome to the Hakka family! You have now landed on a new DeFi planet with massive harvesting potential. Time to farm and sharpen your skills!',
    missionList: [
      MISSION_CAMPAIGN_ID[MissionOptions.MISSION2_1],
      MISSION_CAMPAIGN_ID[MissionOptions.MISSION2_2],
      MISSION_CAMPAIGN_ID[MissionOptions.MISSION2_3],
